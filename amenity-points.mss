@marina-text: @amenity-text; // also swimming_pool
@wetland-text: darken(#4aa5fa, 25%); /* Also for marsh and mud */
@shop-icon: @amenity-icon;
@shop-text: @amenity-text;
@transportation-icon: @amenity-icon;
@transportation-text: @amenity-text;
@accommodation-icon: @transportation-icon;
@accommodation-text: @transportation-text;
@airtransport: #8461C4; //also ferry_terminal
@health-color: rgba(255,0,0, 0.3);
@amenity-brown: #734a08;
@gastronomy-icon: @amenity-icon;
@gastronomy-text: darken(@gastronomy-icon, 5%);
@memorials: @amenity-brown;
@culture: @amenity-brown;
@public-service: @amenity-brown;
@office: #4863A0;
@man-made-icon: @amenity-icon;
@advertising-grey: @man-made-icon;
@barrier-icon: @amenity-icon;
@landform-color: #d08f55;
@leisure-green: darken(@park, 60%);
@aboriginal: #82643a;
@religious-icon: @amenity-icon;
